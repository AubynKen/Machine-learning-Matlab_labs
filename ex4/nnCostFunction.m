...
%         computed in ex4.m
    ...
    function a2 = calculate_hypothesis(Theta1, Theta2, X)
        h1 = sigmoid([ones(m, 1) X] * Theta1');
        a2 = sigmoid([ones(m, 1) h1] * Theta2');
    end

hypothesis = calculate_hypothesis(Theta1, Theta2, X);
y_one_hot = y == 1:num_labels;


J = (-1/m) * sum(sum(y_one_hot .* log(hypothesis) + (1-y_one_hot) .* log(1 - hypothesis)));
